...
source "proxmox-iso" "ubuntu-server-noble-numbat-docker" {
    ...
    vm_id = "200"
    vm_name = "ubuntu-server-noble-numbat-docker"
    template_description = "Noble Numbat Docker"
    ...
    template_name        = "packer-ubuntu2404-docker"
...
build {
    ...
    name = "ubuntu-server-noble-numbat-docker"
    sources = ["proxmox-iso.ubuntu-server-noble-numbat-docker"]
